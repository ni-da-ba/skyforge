...
class HostedExecutionCoordinator:
    ...
    def _supersede_preclassifier_plan(
        ...
        *,
        ...
        """Prefer one newer signed same-issue revision before any classifier call."""
        ...
        if (
            ...
            return self._blocked(
                "pre-classifier task revision cannot replace plan after admission exists"
            )
        ...
        if len(candidates) != 1:
            return self._blocked(
                "multiple newer pre-classifier task revisions are pending; operator must disambiguate authority"
            )
