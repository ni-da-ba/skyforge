...
def _render_markdown(report: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        f"| Issue-comment fallback scans | {d.get('issue_comment_reconcile_checks', 0)} |",
        f"| Issue-comment fallback wakes | {d.get('issue_comment_recovered_wakes', 0)} |",
        f"| Issue-comment fallback controls | {d.get('issue_comment_recovered_controls', 0)} |",
