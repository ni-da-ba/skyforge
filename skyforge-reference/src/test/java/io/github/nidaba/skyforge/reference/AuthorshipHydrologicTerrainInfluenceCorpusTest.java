...
class AuthorshipHydrologicTerrainInfluenceCorpusTest {
    @Test
    void generatesReviewCorpus() throws Exception {
        Path output = Path.of("build", "evidence", "authorship-hydrologic-terrain-influence-v1");
        AuthorshipHydrologicTerrainInfluenceCorpusCli.main(new String[] {output.toString()});
