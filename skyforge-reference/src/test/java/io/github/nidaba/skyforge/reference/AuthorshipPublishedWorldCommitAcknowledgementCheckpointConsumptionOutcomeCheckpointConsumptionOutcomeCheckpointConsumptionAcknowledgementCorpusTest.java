...
class AuthorshipPublishedWorldCommitAcknowledgementCheckpointConsumptionOutcomeCheckpointConsumptionOutcomeCheckpointConsumptionAcknowledgementCorpusTest {
    @Test
    void generatesReviewCorpus() throws Exception {
        ...
        AuthorshipPublishedWorldCommitAcknowledgementCheckpointConsumptionOutcomeCheckpointConsumptionOutcomeCheckpointConsumptionAcknowledgementCorpusCli
        ...
        assertTrue(row[0].startsWith("sfackcpoutcpoutack:v1:"));
        assertTrue(row[1].startsWith("sfackcpoutcpoutticket:v1:"));
        assertTrue(row[2].startsWith("sfackcpoutcpouttarget:v1:"));
