...
class AuthorshipPublishedWorldCommitAcknowledgementCheckpointConsumptionOutcomeCheckpointConsumptionTicketCorpusTest {
    @Test
    void generatesReviewCorpus() throws Exception {
        ...
        AuthorshipPublishedWorldCommitAcknowledgementCheckpointConsumptionOutcomeCheckpointConsumptionTicketCorpusCli
        ...
        assertTrue(ticketRow[0].startsWith("sfackcpoutticket:v1:"));
        assertTrue(ticketRow[1].startsWith("sfackcpoutprep:v1:"));
        assertTrue(ticketRow[2].startsWith("sfackcpouttarget:v1:"));
