...
class AuthorshipPublishedWorldCommitAcknowledgementCheckpointConsumptionOutcomeCheckpointBindingCorpusTest {
    @Test
    void generatesReviewCorpus() throws Exception {
        ...
        AuthorshipPublishedWorldCommitAcknowledgementCheckpointConsumptionOutcomeCheckpointBindingCorpusCli
        ...
        assertTrue(bindingRow[0].startsWith("sfackcpoutbinding:v1:"));
