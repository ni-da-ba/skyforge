...
class AuthorshipPublishedWorldCommitAcknowledgementCheckpointConsumptionOutcomeCheckpointConsumptionAcknowledgementSetCorpusTest {
    @Test
    void generatesReviewCorpus() throws Exception {
        ...
        AuthorshipPublishedWorldCommitAcknowledgementCheckpointConsumptionOutcomeCheckpointConsumptionAcknowledgementSetCorpusCli
        ...
        assertEquals("scenario,pass,setSize", manifest.lines().findFirst().orElseThrow());
