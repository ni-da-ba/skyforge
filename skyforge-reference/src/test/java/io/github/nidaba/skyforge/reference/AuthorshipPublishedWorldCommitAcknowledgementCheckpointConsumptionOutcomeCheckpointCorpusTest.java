...
class AuthorshipPublishedWorldCommitAcknowledgementCheckpointConsumptionOutcomeCheckpointCorpusTest {
    @Test
    void generatesReviewCorpus() throws Exception {
        ...
        AuthorshipPublishedWorldCommitAcknowledgementCheckpointConsumptionOutcomeCheckpointCorpusCli
        ...
        assertTrue(checkpointRow[0].startsWith("sfackcpoutcp:v1:"));
