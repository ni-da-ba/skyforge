...
/**
 * Bounded continuous centerline derived from one deterministic fine-lattice search route.
 *
 * <p>The search route remains semantic/terrain-routing authority. This representation regularizes
 * grid stair-stepping before hydraulic geometry and curvature diagnostics are computed.
 */
