...
/** AUTH-0073 validation of one exact outcome-checkpoint binding against one activation state. */
public record SkyIslandPublishedWorldCommitAcknowledgementCheckpointConsumptionOutcomeCheckpointBindingValidation(
