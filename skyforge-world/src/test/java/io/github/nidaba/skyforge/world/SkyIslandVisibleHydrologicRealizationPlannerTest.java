...
final class SkyIslandVisibleHydrologicRealizationPlannerTest {
    ...
    @Test
    void retainedBasinChannelSegmentsRemainExplicitAuthoredIntent() {
        ...
        assertEquals(
                ...
                "retained-water ownership may alter backend realization but must not delete accepted channel intent");
    }
    ...
    @Test
    void planRejectsMislabeledCrossIslandNestedHydrologyComposition() {
        SkyIslandVisibleHydrologicRealizationPlan a =
                SkyIslandVisibleHydrologicRealizationPlanner.plan(descriptor(77L));
        SkyIslandVisibleHydrologicRealizationPlan b =
                SkyIslandVisibleHydrologicRealizationPlanner.plan(descriptor(83L));

        SkyIslandCoherentHydrologicRealizationPlan mislabeled =
                new SkyIslandCoherentHydrologicRealizationPlan(
                        a.descriptor(),
                        b.coherentHydrology().channels(),
                        b.coherentHydrology().riparian(),
                        b.coherentHydrology().drops(),
                        b.coherentHydrology().terrainInfluence(),
                        b.coherentHydrology().terrainSurface(),
                        b.coherentHydrology().naturalizedChannels());
    ...
    void lockedCanonicalSpecimenRetainsDeterministicMultiPositionNaturalizedChannel() {
        ...
        assertEquals(
                ...
                channel.path(),
                "AUTH-0104 must preserve exact channel provenance rather than synthesize topology");
        assertEquals(
