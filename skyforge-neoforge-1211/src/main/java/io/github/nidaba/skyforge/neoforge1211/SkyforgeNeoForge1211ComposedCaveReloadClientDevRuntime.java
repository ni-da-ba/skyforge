...
/** ClientLevel half of the SF-IMP-0067 persisted native/authored cave-union proof. */
@EventBusSubscriber(modid = SkyforgeNeoForge1211Mod.MOD_ID, value = Dist.CLIENT)
final class SkyforgeNeoForge1211ComposedCaveReloadClientDevRuntime {
    private static final System.Logger LOGGER =
            System.getLogger(SkyforgeNeoForge1211ComposedCaveReloadClientDevRuntime.class.getName());
    ...
    private SkyforgeNeoForge1211ComposedCaveReloadClientDevRuntime() {}

    @SubscribeEvent
    static void onClientTick(ClientTickEvent.Post event) {
        if (proofComplete || !SkyforgeNeoForge1211ComposedCaveReloadDevRuntime.enabled()) {
            return;
        }
        ...
        if (SkyforgeAutomatedAcceptanceHarness.clientMode()
            ...
            SkyforgeAutomatedAcceptanceHarness.failClientCase(
                    "SF-IMP-0067 reload client did not reach composed cave verification within 90 seconds");
        }

        var expectation = SkyforgeNeoForge1211ComposedCaveReloadDevRuntime.clientExpectation();
        if (expectation == null) {
            return;
        }
        ...
        if (!nativeOnlyState.equals(expectation.nativeOnlyState())
            ...
            throw new IllegalStateException(
                    "SF-IMP-0067 ClientLevel disagreed with persisted cave union: nativeOnly="
        ...
        LOGGER.log(
                ...
                "SF-IMP-0067 RELOAD CLIENT PASS: nativeOnly=" + nativeOnly
