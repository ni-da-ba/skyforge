...
public final class SkyforgeNeoForge1211Mod {
    ...
    public SkyforgeNeoForge1211Mod(IEventBus modEventBus) {
        ...
        SkyforgeAircraftCompilerRuntimeAcceptance.installFromSystemProperty();
        SkyforgeAircraftCompilerPilotWorldPrepareAcceptance.installFromSystemProperty();
        SkyforgeAircraftCompilerPilotClientRuntimeAcceptance.installFromSystemProperty();
