...
Development-only Minecraft 1.21.1 datapack fallback for the Wave C2 early-glider recipe.
...
replacing the two Phantom Membranes with the ordinary `minecraft:wool` item tag.
