...
neoForge {
    ...
    runs {
        ...
        create("dr70HumanReviewAtlasPrepare") {
            server()
            gameDirectory = layout.projectDirectory.dir("run-dr70-human-review-atlas-v8").asFile
            programArgument("--nogui")
            programArgument("--universe")
            programArgument("saves")
            programArgument("--world")
...
tasks.named("runDr70HumanReviewAtlasPrepare").configure {
    ...
    doFirst {
        val directory = layout.projectDirectory.dir("run-dr70-human-review-atlas-v8").asFile
        directory.mkdirs()
        directory.resolve("eula.txt").writeText("eula=true\n")
