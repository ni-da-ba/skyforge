...
**Snapshot:** 2026-09-06  
**Status:** Historical source-constrained topology recomposed for current-main live validation.  
**Parent:** CONTENT C12 / issue #239

> **Recomposition provenance:** historical PR #242 / head `797e0c54325b1f45d0aa6229124c3bb7e8727bda`
> closed unmerged. C12 reuses this document only as a source-constrained construction proposal.
> Current live Physics Assembler/Sable evidence overrides every paper assumption.
