...
**Snapshot:** 2026-09-06  
**Status:** Historical analytic estimate recomposed for comparison only; live Sable measurement is authoritative.  
**Parent:** CONTENT C12 / issue #239

> **Recomposition provenance:** historical PR #242 / head `797e0c54325b1f45d0aa6229124c3bb7e8727bda`.
> No paper mass or centroid in this note is accepted aircraft evidence.
