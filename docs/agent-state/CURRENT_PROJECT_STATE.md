...
This file is a compact bootstrap cache for disposable/manual/hosted agents. It is intentionally small. It does **not** override current `main`, source/tests, merged history, active issue/PR authority, or live orchestrator state.
...
- The canonical island surface composition reads as surprisingly coherent and interesting.
- Cave/interior composition is coherent and interesting, even if not yet especially dramatic.
- Do not broadly reshape the working island massing or cave foundation merely to address the current DR-60 rejection.

### Required DR-60 corrections

1. **Canopy headroom** — tall jungle trees can reach the upper production boundary and have their tops clipped. Tall-vegetation placement must account for remaining vertical headroom; chopped canopies are a generation defect.
