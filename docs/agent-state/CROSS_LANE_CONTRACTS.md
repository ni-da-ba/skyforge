...
AUTH-0103 / issue #707 is the DR-40 consumer-driven candidate bridge for exact AUTH-0046 associations whose runtime volumes are not AUTH-0058 publications. It must preserve AUTH-0088 surface-projection semantics, AUTH-0090 area weighting, and AUTH-0092 raw isolation semantics without weakening AUTH-0087. The locked DR-00 singleton has no regional neighbor; that absence is diagnostic only and is not population-pressure authority.
